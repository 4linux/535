...
vms = {
  'ansible-server' => {'memory' => '2048', 'cpus' => 1, 'ip' => '200', 'box' => 'devopsbox/ubuntu-20.04', 'provision' => 'provision/ansible/ansible-server.yaml'},
  ...
  'dbserver' => {'memory' => '1024', 'cpus' => 1, 'ip' => '203', 'box' => 'devopsbox/debian-10.11', 'provision' => 'provision/ansible/dbserver.yaml'}
}
